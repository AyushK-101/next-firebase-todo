...
export default function Home() {
    ...
    const addToDo = async () => {
        try {
            ...
            // After adding the new todo, fetch all todos for the current user and update the state 
            fetchTodos(authUser.uid);
    ...
    const makeAsCompleteHander = async (event, docId) => {
        try {
            ...
            // Update the "completed" field of the todo document to the value of the "checked" property
            ...
            <div className="max-w-3xl mx-auto mt-10 p-8">
                <div className="bg-white -m-6 p-3 sticky top-0">
                    <div className="flex justify-center flex-col items-center">
                        <span className="text-7xl mb-10">✍️</span>
                    ...
                    <div className="flex items-center gap-2 mt-10">
                        <input
                            placeholder={`👋 Hello ${authUser.username}, what are you up to today?`}
                            type="text"
